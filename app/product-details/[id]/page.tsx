...
import productImage1 from "@/public/assets/product-details/product-details-image-1.png";
import productImage2 from "@/public/assets/product-details/product-details-image-2.png";
import productImage3 from "@/public/assets/product-details/product-details-image-3.png";
import productImage4 from "@/public/assets/product-details/product-details-image-4.png";
import Image from "next/image";
import { useState } from "react";

const galleryImages = [productImage1, productImage2, productImage3, productImage4];
        ...
        <div className="lg:w-107.5 flex flex-col gap-4 lg:gap-6">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <ul className="list-disc pl-5 flex flex-col gap-1">
              <li className="text-dark-gray/70 text-[12px] lg:text-[14px] leading-[160%]">
